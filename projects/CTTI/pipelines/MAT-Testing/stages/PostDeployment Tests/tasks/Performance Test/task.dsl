...
task 'Performance Test', {
  actualParameter = [
    ...
    'job_name': 'MAT-PROVES-RENDIMENT-JMETER',
    'need_to_run_report': '1',
    'need_to_trim_key': '1',
    'need_to_trim_value': '1',
    'parameters': '(repositorio=http://gitea.gitea/devsecops/performance-test, entorno=Integracio, rama=master, urlapp=qualitat.solucions.gencat.cat, protocol=https, testDuration=10, rampup=60, threadCount=20, umbral=20)',
    'quote_char': '',
    'sep_char': '',
  ]
