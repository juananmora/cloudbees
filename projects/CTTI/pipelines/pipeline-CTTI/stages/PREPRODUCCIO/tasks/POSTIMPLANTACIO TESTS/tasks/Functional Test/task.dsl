...
task 'Functional Test', {
  actualParameter = [
    ...
    'parameters': '(repositorio=http://gitea.gitea/devsecops/functional-test, entorno=Preproduccio, rama=master, urlapp=https://qualitat.solucions.gencat.cat, umbral=20)',
    'quote_char': '',
    'sep_char': '',
  ]
