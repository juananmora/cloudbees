...
task 'Performance Test', {
  actualParameter = [
    ...
    'parameters': '(repositorio=http://gitea.gitea/devsecops/performance-test, entorno=Integracio, rama=master, urlapp=qualitat.solucions.gencat.cat, protocol=https, testDuration=10, rampup=60, threadCount=20, UMBRAL=70)',
    'quote_char': '',
    'sep_char': '',
  ]
